...
export default function Footer() {
  ...
  const footerBg = pathname === '/community-support' || pathname === '/profile' ? 'bg-[#FDF8F3]' : 'bg-[#F9F9F9]'
    ...
    <footer className={`${footerBg} relative z-[1]`}>
      ...
      <div className="max-w-[1415px] mx-auto px-4">
        ...
        <div className="flex justify-between items-center pb-10">
          <span
            className="text-[14px] font-normal text-[#333231]"
            style={font}
          >
            Licensed by Navaro
          </span>
          <Link
            href="/privacy"
            className="text-[14px] font-normal text-[#333231] hover:opacity-70 transition-opacity"
            style={font}
          >
            Privacy Policy
          </Link>
