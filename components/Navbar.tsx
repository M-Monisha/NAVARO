          ...
          <div className="flex items-center justify-between flex-nowrap">
            ...
            <div className="block max-[800px]:hidden">
              <ul className="flex list-none p-0 m-0">
                <li>
                  <Link href="/" className="text-[#1E1E1E] text-lg font-normal leading-[120%] px-4 inline-block hover:opacity-70 transition-opacity" style={{ fontFamily: '"TASA Orbiter Deck", sans-serif' }}>
                    Home
                  </Link>
                </li>
                <li>
        ...
        <div className="fixed inset-0 bg-[#C780ED] z-[999] flex items-center max-[800px]:flex hidden">
          ...
          <div className="px-6">
            <ul className="list-none p-0 m-0">
              <li className="mb-2.5">
                <Link href="/" onClick={() => setIsMenuOpen(false)} className="text-white text-xl block" style={{ fontFamily: '"TASA Orbiter Deck", sans-serif' }}>
                  Home
                </Link>
              </li>
              <li className="mb-2.5">
